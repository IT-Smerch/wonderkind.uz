...
(function(window, document, undefined) {
    ...
    var elementMethods = {
        ...
        sAddClass: function(classes) {
            var elem = this,
                classArr = classes.split(/\s/g),
                classLength = classArr.length,
                clInd;
            if (classListFlag) {
        ...
        sCSS: function(property, value) {
            var elem = this,
                css3Reg = new RegExp('perspective|transform|box-sizing|user-select', 'g');
        ...
        sDataset: function() {
            ...
            if (elem.dataset) {
                ...
                var elAttr = elem.attributes,
                    attrLen = elAttr.length;
    ...
    var pluginMethods = {
        init: function(element, params) {
            ...
            if (wrap && typeof(params) !== 'string') {
                ...
                var imagesLength = contentImages.length,
                    hasSVG = false;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var layers, content_width, flip, full_width, elements = {},
        comments = {};
